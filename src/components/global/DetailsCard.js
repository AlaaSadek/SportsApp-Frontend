...
const styles = StyleSheet.create({
    container: {
        ...
        marginTop: Dimensions.get('window').height > 740 ? Dimensions.get('window').height * 0.64 : Dimensions.get('window').height > 640 ? Dimensions.get('window').height * 0.55 : Dimensions.get('window').height * 0.41,
    ...
    termsAndCondition: {
        ...
        fontFamily: 'Montserrat_SemiBold',
        color: 'black',
        marginTop: Dimensions.get('window').height > 740 ? Dimensions.get('window').height * 0.24 : Dimensions.get('window').height * 0.23,
        position: 'absolute',
        flex: 1
    },
    chooseClassButton: {
        marginTop: Dimensions.get('window').height > 740 ? Dimensions.get('window').height * 0.31: Dimensions.get('screen').height * 0.31,
        paddingHorizontal: "6%",
